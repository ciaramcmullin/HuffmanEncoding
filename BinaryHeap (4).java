...
public class BinaryHeap<E extends Comparable>
{
    ...
    /**
     * Internal method to percolate down in the heap.v
    ...
    /**
     * method that returns number of elements in the heap
     * @return currentSize
     */
    public int getSize() {
    ...
    /**
     * method that returns String of array values
     * @return String
     */
    public String toString() {
        String s = "";
        for (int i = 1; i < this.array.length-2; i++) {
            s += this.array[i] + " ";
        }
        return s;
    }
